...
before building decks on them. `lib/mj.js`, `tools/demos/mj_demo.html`, `tools/twins/mujoco.json`
and `tutorial/mjview.py` were reviewed or written on 2026-09-24 (section 6). Known gaps:
