...
before building decks on them. `lib/mj.js`, `lib/plot.js`, `tools/demos/mj_demo.html`,
`tools/demos/plot_demo.html`, `tools/twins/mujoco.json` and `tutorial/mjview.py` were reviewed or
written on 2026-09-24 (section 6). Known gaps:
