...
`slides/README.md`. (`slides/index.html` already lists the 22-deck series, links the six
existing decks, and carries the Hou & Mason reading path; link each new deck there as it lands.)
